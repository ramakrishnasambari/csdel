      ...
      <div className="footer-container">
        ...
        <div className="footer-column footer-links">
          ...
          <ul>
            ...
            <li><button onClick={() => scrollToSection('who-we-are')}>Who We Are</button></li>
        ...
        <div className="footer-column footer-contact">
          <h3>Get in touch</h3>
          <p><strong>Email:</strong> csdelindia@gmail.com</p>
          <p><strong>Call Us:</strong> (+91) 9891921959,<br />9910849280, 7011025490</p>
        </div>
      </div>

      <div className="footer-bottom">
        <p>&copy; 2025 Council for Sustainable Development and Environment Leadership</p>
      </div>
